...
if (!function_exists('html_purify'))
{
    ...
    {
        require_once APPPATH . 'third_party/htmlpurifier-4.15.0-standalone/HTMLPurifier.standalone.php';
...
//                    $config->set('HTML.Doctype', 'XHTML 1.0 Strict');
                    ...
                    $config->set('HTML.Allowed', 'p,a[href|target|title],abbr[title],acronym[title],b,strong,blockquote[cite],code,em,i,strike');
