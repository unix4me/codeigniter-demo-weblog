...
<html lang="en">
    ...
    <body>
        ...
        <footer class="blog-footer">
            {footerbar}
            <p>If you are exploring <a href="https://codeigniter.com/" target="_blank">CodeIgniter</a> for the very first time, you should start by reading the <a href="/user_guide/" target="_blank">User Guide</a>.</p>
